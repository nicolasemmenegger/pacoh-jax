...
from pacoh.modules.belief import GaussianPosterior, GaussianPrior
...
class BayesianNeuralNetworkVI(RegressionModel):
    ...
    def __init__(self, x_train, y_train, hidden_layer_sizes=(32, 32), activation='elu',
        ...
        # setup prior
        # TODO this could be a function that adds up the scalar dimensions of the pytree params you get from init
        ...
        # param size, std. The likelihood also has some param
        ...
        # Likelihood
        # TODO the likelihood is trainable and takes the output dim and the number of batched models
